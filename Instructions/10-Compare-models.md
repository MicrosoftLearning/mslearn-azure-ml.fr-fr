...
Toutes les ressources nécessaires étant à votre disposition, vous pouvez exécuter le notebook pour envoyer le travail, qui utilise MLflow afin de suivre les paramètres, les métriques et les artefacts du modèle.
