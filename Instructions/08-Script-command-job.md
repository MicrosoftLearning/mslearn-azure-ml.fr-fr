...
1. Nommez le nouveau fichier `train-classification-model.py`. 
...
1. Passez en revue les propriétés du travail. Notez que **Command** affiche la valeur du paramètre **command** du travail de commande : la commande que vous avez exécutée pour exécuter le script.
