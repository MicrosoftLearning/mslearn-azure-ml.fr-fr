---
lab:
  title: Exécuter des pipelines dans Azure Machine Learning
---

# Exécuter des pipelines dans Azure Machine Learning

Vous pouvez utiliser le SDK Python pour accomplir toutes les tâches requises pour créer et utiliser une solution de machine learning dans Azure. Au lieu d’accomplir ces tâches individuellement, vous pouvez utiliser des pipelines pour orchestrer les étapes requises pour préparer les données, exécuter les scripts d’entraînement et autres tâches.

Dans cet exercice, vous allez exécuter plusieurs scripts en tant que travail de pipeline.
...
Le code pour créer et soumettre un pipeline avec le SDK Python est fourni dans un notebook.

1. Ouvrez le notebook **Labs/09/Run a pipeline job.ipynb**.
